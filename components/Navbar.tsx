                                    ...
                                    {userMenuOpen && (
                                        ...
                                        >
                                            ...
                                            <Link
                                                ...
                                                className="w-full flex items-center gap-2.5 px-3.5 py-2.5 text-[13px] text-[var(--text-secondary)] hover:text-white hover:bg-[var(--surface-hover)] transition-colors"
                                            >
                                            ...
                                            {userRole === "admin" && (
                                                <Link
                                                    href="/admin"
                                                    onClick={() => setUserMenuOpen(false)}
                                                    className="w-full flex items-center gap-2.5 px-3.5 py-2.5 text-[13px] text-[var(--accent)] hover:bg-[var(--accent-subtle)] transition-colors"
                                                >
                                                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                {mobileOpen && (
                    ...
                    >
                        <div className="px-6 py-4 space-y-1">
                            ...
                            {user && (
                                <>
                                    <Link href="/dashboard" onClick={() => setMobileOpen(false)} className="block px-3 py-2.5 text-sm text-white/60 hover:text-white rounded-lg transition-colors">
                                        A minha conta
                                    </Link>
                                    {userRole === "admin" && (
                                        <Link href="/admin" onClick={() => setMobileOpen(false)} className="block px-3 py-2.5 text-sm text-[var(--accent)] rounded-lg transition-colors">
                                            Painel Admin
                                        </Link>
                                    )}
                                </>
